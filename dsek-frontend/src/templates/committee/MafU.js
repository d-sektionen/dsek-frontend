    ...
    return (
        <div className="MafU">
            ...
            <p>
                ...
                Vill du veta mer om hemmissioneringen klicka <a>här</a>.
            </p>
            ...
            <p>
                Ansök om att hemmissionera i följande <a>formulär</a>. 
            </p>
            <p>
            ...
            <p>
                Mer information och en steg för steg guide om hur du hemmissionerar finns på <a>lith.liu.se/samverkan/hemmissionering</a>
            </p>
            <p>
                Material till hemmissionering 
                Powerpoint-fil för presentation: tryck <a>här</a>. 
                Checklista inför digital hemmissionering: tryck <a>här</a>. 
                Vid frågor maila MafU på henrik.thoren@d-sektionen.se 
                Taggad? Intresseanmäl dig då <a>här</a> för att hemmissionera.
            </p>
        </div>
    );
}
