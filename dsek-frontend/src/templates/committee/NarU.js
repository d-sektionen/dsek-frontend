        ...
        <>
            ...
            <div className="NarU">
                ...
                <div className="NarU-Section">
                    <h2>Företag?</h2>
                    <hr />
                    <p className="NarU-Text">Information för företag och organisationer finner ni under fliken <a href="https://d-sektionen.se/page/foretag/" className="NarU-Link">Företag</a>. </p>
                </div>
