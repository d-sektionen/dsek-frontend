function NarU() {
    return (
        <div className="NarU">
            ...
            <h2>Företag?</h2>
            <p>Information för företag och organisationer finner ni under <a>Företag</a>.</p>
            ...
            <p>
                ...
                Vi annonserar även på vår <a>Facebook-sida</a>, gilla den för att ta del av allt spännande som händer.
            </p>

            <h2>Hjälp oss</h2>
            <p>Vi arbetar kontinuerligt med att förbättra sektionens näringslivsverksamhet och är därför i ett stort behov av dina idéer och åsikter.</p>
            <ul>
            ...
            <p>Mejla förslag och tips till Näringslivsansvarig.</p>
        </div>
    );
}
