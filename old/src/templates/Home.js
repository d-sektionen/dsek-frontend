      ...
      <div className="Middle">
        ...
        {posts.map((post, index) => (
          <PostPreview
            ...
            content={post.attributes.preview_content}
            slug={"/blogpost/" + post.attributes.slug}
            thumbnailURL={
              post.attributes.thumbnail.data !== null
            ...
            thumbnailWidth={
              post.attributes.thumbnail.data !== null
                ? post.attributes.thumbnail.data.attributes.width
                : 100
            }
            thumbnailHeight={
              post.attributes.thumbnail.data !== null
                ? post.attributes.thumbnail.data.attributes.height
                : 100
            }
            id={post.id}
          />
