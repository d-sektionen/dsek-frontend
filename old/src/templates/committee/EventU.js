      ...
      <div className="EventU">
        {eventu && (
          <div className={eventu.attributes.slug}>
            ...
            <Markdown className="EventU-Desc" remarkPlugins={[remarkGfm]}>
              {eventu.attributes.preview_content}
            </Markdown>
            <Markdown className="EventU-Content" remarkPlugins={[remarkGfm]}>
              {eventu.attributes.content}
            </Markdown>
            <hr />
            <h2 className="EventU-Sub-Title">Eventutskottets Undergrupper</h2>
            {data &&
            ...
            <p className="utskott_content_date">
              Senaste redigerad: {showDatetime(eventu.attributes.publishedAt)}
            </p>
          </div>
        )}
      </div>
