        ...
        <div className="utskott ">
          {utskott && (
            <div className={utskott.attributes.slug}>
              <h1 className="utskott_header_title">
                {utskott.attributes.title}
              </h1>
              <Markdown
                className="utskott_header_description"
                remarkPlugins={[remarkGfm]}
              >
                {utskott.attributes.preview_content}
              </Markdown>
              <Markdown
                className="utskott_content_text"
                remarkPlugins={[remarkGfm]}
              >
                {utskott.attributes.content}
              </Markdown>
              <p className="utskott_content_date">
                Senaste redigerad:{" "}
                {showDatetime(utskott.attributes.publishedAt)}
              </p>
            </div>
          )}
        </div>
